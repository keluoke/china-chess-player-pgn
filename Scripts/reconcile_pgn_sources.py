...
def write_audit_reports(
    ...
    if not dry_run:
        ...
        # semantically unchanged report.  Render Markdown from the persisted
        # manifest so both surfaces share that same snapshot timestamp.
        persisted_summary = read_json(manifest_path)
