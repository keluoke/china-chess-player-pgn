    ...
    for fide_id in sorted(game_counts):
        ...
        payload = {
            ...
            **compact_player(identity),
            ...
            "archivedGameCount": game_counts[fide_id],
            "playableGameCount": detail.get("totals", {}).get("playableGames", 0),
            "excludedGameCount": detail.get("totals", {}).get("excludedGames", 0),
            "participationEventCount": detail.get("totals", {}).get("participationEvents", 0),
            "publishedParticipationEventCount": len(events),
            "pgnEventCount": detail.get("totals", {}).get("pgnEvents", 0),
