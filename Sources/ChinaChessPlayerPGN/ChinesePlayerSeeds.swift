...
struct ChinesePlayerSeed {
    ...
    init(
        ...
        self.standardRating = standardRating
...
enum ChinesePlayerSeeds {
    static let players: [ChinesePlayerSeed] = [
        ...
        .init(fideID: "8603677", chineseName: "丁立人", pinyinName: "ding liren", englishName: "Ding, Liren", federation: "CHN", aliases: ["丁立人", "dingliren", "Ding Liren", "Ding, Liren"]),
        .init(fideID: "8603405", chineseName: "韦奕", pinyinName: "wei yi", englishName: "Wei, Yi", federation: "CHN", aliases: ["韦奕", "weiyi", "Wei Yi", "Wei, Yi"]),
        .init(fideID: "8603820", chineseName: "余泱漪", pinyinName: "yu yangyi", englishName: "Yu, Yangyi", federation: "CHN", aliases: ["余泱漪", "yuyangyi", "Yu Yangyi", "Yu, Yangyi"]),
        .init(fideID: "8602980", chineseName: "侯逸凡", pinyinName: "hou yifan", englishName: "Hou, Yifan", federation: "CHN", aliases: ["侯逸凡", "houyifan", "Hou Yifan", "Hou, Yifan"]),
        .init(fideID: "8603006", chineseName: "居文君", pinyinName: "ju wenjun", englishName: "Ju, Wenjun", federation: "CHN", aliases: ["居文君", "juwenjun", "Ju Wenjun", "Ju, Wenjun"]),
        .init(fideID: "8605114", chineseName: "雷挺婕", pinyinName: "lei tingjie", englishName: "Lei, Tingjie", federation: "CHN", aliases: ["雷挺婕", "leitingjie", "Lei Tingjie", "Lei, Tingjie"]),
        ...
        .init(fideID: "8600040", chineseName: "叶江川", pinyinName: "ye jiangchuan", englishName: "Ye, Jiangchuan", federation: "CHN", aliases: ["叶江川", "yejiangchuan", "Ye Jiangchuan", "Ye, Jiangchuan"]),
        .init(fideID: "8600147", chineseName: "谢军", pinyinName: "xie jun", englishName: "Xie, Jun", federation: "CHN", aliases: ["谢军", "xiejun", "Xie Jun", "Xie, Jun"]),
        .init(fideID: "8600635", chineseName: "许昱华", pinyinName: "xu yuhua", englishName: "Xu, Yuhua", federation: "CHN", aliases: ["许昱华", "xuyuhua", "Xu Yuhua", "Xu, Yuhua"]),
        .init(fideID: "8601445", chineseName: "卜祥志", pinyinName: "bu xiangzhi", englishName: "Bu, Xiangzhi", federation: "CHN", aliases: ["卜祥志", "buxiangzhi", "Bu Xiangzhi", "Bu, Xiangzhi"]),
        ...
        .init(fideID: "8601160", chineseName: "倪华", pinyinName: "ni hua", englishName: "Ni, Hua", federation: "CHN", aliases: ["倪华", "nihua", "Ni Hua", "Ni, Hua"]),
